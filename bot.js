...
${chalk.blue.italic('ℹ️ Connecting to WhatsApp...')}`);
    ...
    if (config.SUPPORT == '919207883470-1634479450@g.us') {     
    ...
    if (config.SUPPORT3 == '919207883470-1634479450@g.us') {     
...
*/
                        try {
                            ...
                            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                                ...
                                await conn.sendMessage(conn.user.jid, '*~_________~ 𝗙𝗶𝗱𝗵𝗮𝗠𝘄𝗼𝗹 ~______~*' +
                                    '\n\n*🧞‍♂️ ' + error + '*\n\n*Support group*\nchat.whatsapp.com/BaNYBsxCyEyGsmx5us44ph' 
                                    , MessageType.text);
                            }
                        }
                    }
